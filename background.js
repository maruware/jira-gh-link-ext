...
function setBadgeText(text) {
    ...
    return new Promise((resolve) => chrome.browserAction.setBadgeText({
        text: string
    }, resolve));
}
function setBadgeBackgroundColor(color) {
    return new Promise((resolve) => chrome.browserAction.setBadgeBackgroundColor({
        color
    }, resolve));
}
...
function getContent() {
    ...
    const issueName = document.querySelector("[data-test-id='issue.views.issue-base.foundation.breadcrumbs.breadcrumb-current-issue-container'] a span").textContent
